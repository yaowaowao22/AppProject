...
export function GameScreen() {
  ...
  const [selectedLevel, setSelectedLevel] = useState<Yojijukugo['level']>('basic');
  ...
  const handleStartQuiz = useCallback(() => {
    const q = generateQuestions(selectedLevel, selectedMode, selectedCount);
    ...
    setElapsedTime(0);
    setPhase('playing');
  }, [selectedLevel, selectedMode, selectedCount]);
  ...
  const handleNext = useCallback(() => {
    ...
    if (nextIndex >= questions.length) {
      ...
      const result: QuizResult = {
        ...
        quizMode: QUIZ_MODE_LABELS[selectedMode],
        correct: score,
          ...
          <View style={[styles.optionRow, { marginBottom: spacing.lg }]}>
            {LEVEL_OPTIONS.map((opt) => (
              ...
              >
                <Body
                  color={
                    selectedLevel === opt.key ? '#FFFFFF' : colors.text
                  }
          ...
          <View style={[styles.optionRow, { marginBottom: spacing.lg }]}>
            {QUIZ_MODES.map((mode) => (
              ...
              >
                <Body
                  color={
                    selectedMode === mode.key ? '#FFFFFF' : colors.text
                  }
        ...
        <View style={[styles.container, { padding: spacing.xl }]}>
          <View style={styles.resultContainer}>
            ...
            <Card style={[styles.resultCard, { marginBottom: spacing.lg }]}>
              ...
              />
              <View style={styles.resultRow}>
                <Body color={colors.textSecondary}>出題形式</Body>
                <H3>{QUIZ_MODE_LABELS[selectedMode]}</H3>
              </View>
              <View
                style={[
                  styles.resultDivider,
      ...
      >
        ...
        <View style={{ alignItems: 'center', marginBottom: spacing.sm }}>
          <Caption color={colors.textMuted}>
            {LEVEL_LABELS[selectedLevel]}・{getModeLabel()}
          </Caption>
        </View>
          ...
          <>
            ...
            >
              <H2
                align="center"
                style={{
                  fontSize: selectedMode === 'meaning' ? 18 : 28,
                  lineHeight: selectedMode === 'meaning' ? 28 : 40,
                }}
              >
                ...
                return (
                  ...
                  >
                    <Body
                      ...
                      style={{
                        fontWeight: '600',
                        fontSize: selectedMode === 'fill' ? 24 : 16,
                        textAlign: 'center',
                      }}
                    >
                      {choice}
