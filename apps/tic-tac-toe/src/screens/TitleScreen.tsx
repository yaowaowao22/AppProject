...
export function TitleScreen() {
  ...
  const [history] = useLocalStorage<GameResult[]>('tictactoe_history', []);
      ...
      <View style={[styles.container, { padding: spacing.xl }]}>
        ...
        <Card style={[styles.statsCard, { padding: spacing.lg, marginBottom: spacing.xl }]}>
          ...
          <View style={[styles.statsRow, { marginBottom: spacing.xs }]}>
            <Body>勝利</Body>
            <Body
              color={stats.wins > 0 ? colors.success : colors.textMuted}
          ...
          <View style={[styles.statsRow, { marginBottom: spacing.xs }]}>
            <Body>敗北</Body>
            <Body
              color={stats.losses > 0 ? colors.error : colors.textMuted}
