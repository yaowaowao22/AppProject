...
import type { Era, HistoryQuestion, QuizCount } from '../data/questions';
...
export function GameScreen() {
  ...
  const [selectedEra, setSelectedEra] = useState<Era>('全時代');
  ...
  const handleStartQuiz = useCallback(() => {
    const q = generateQuiz(selectedEra, selectedCount);
          ...
          <View style={[styles.optionRow, { marginBottom: spacing.lg }]}>
            {ERAS.map((era) => (
              ...
              >
                <Body
                  color={
                    selectedEra === era ? '#FFFFFF' : colors.text
                  }
      ...
      >
        ...
        <View style={{ alignItems: 'center', marginBottom: spacing.sm }}>
          <Caption color={colors.textMuted}>
            {currentQuestion ? currentQuestion.era : ERA_LABELS[selectedEra]}
          </Caption>
        </View>
          ...
          <>
            ...
            >
              ...
              {hintRevealed && phase === 'playing' && (
                ...
                >
                  ヒント: {currentQuestion.options[currentQuestion.correctIndex].charAt(0)}...
                </Body>
              )}
            </Card>
            ...
            {/* Feedback: explanation with era context */}
            {phase === 'feedback' && (
