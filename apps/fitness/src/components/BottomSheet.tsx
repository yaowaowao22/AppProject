...
export function SheetRow({ label, detail, value, badge, isLast }: SheetRowProps) {
  return (
    <View style={[sheetRowStyles.row, isLast && sheetRowStyles.last]}>
      <View style={sheetRowStyles.left}>
        <Text style={sheetRowStyles.name}>{label}</Text>
        {!!detail && <Text style={sheetRowStyles.detail}>{detail}</Text>}
      </View>
      <View style={sheetRowStyles.right}>
        {badge && <View style={sheetRowStyles.prBadge}><Text style={sheetRowStyles.prText}>PR</Text></View>}
        {!!value && <Text style={sheetRowStyles.val}>{value}</Text>}
      </View>
    </View>
  );
}
