...
export function GameScreen() {
  ...
  const mode: QuizMode = route.params?.mode ?? 'capital';
  ...
  const currentPrefecture = currentQuestion
    ? prefectures.find((p) => p.id === currentQuestion.prefectureId)
    : null;
  ...
  return (
    <ScreenWrapper>
      <View style={[styles.container, { padding: spacing.lg }]}>
        ...
        {phase === 'feedback' && currentPrefecture && (
          <Card
            style={[
              styles.feedbackCard,
              {
          ...
          >
            ...
            <Caption style={{ textAlign: 'center', marginBottom: spacing.sm }}>
